...
```{r}
kable(
  tibble(`Model 1` = c("Chi-Squared", "DF", "p", "GFI", "AGFI", "CFI", "TLI", "SRMR", "RMSEA"),
               Value = round(
...
```{r}
kable(
  tibble(`Model 2` = c("Chi-Squared", "DF", "p", "GFI", "AGFI", "CFI", "TLI", "SRMR", "RMSEA"),
               Value = round(
                 fitmeasures(model2, c("chisq", "df", "pvalue", "gfi", "agfi", "cfi", "tli", "srmr", "rmsea")), 4)
    )
)
```
